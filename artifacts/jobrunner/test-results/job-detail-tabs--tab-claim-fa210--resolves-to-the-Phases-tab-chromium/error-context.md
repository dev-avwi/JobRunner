...
- Name: job-detail-tabs.spec.ts >> ?tab=claims on a project resolves to the Phases tab
- Location: e2e/job-detail-tabs.spec.ts:263:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:22128/jobs/prj-1?tab=claims
Call log:
  - navigating to "http://localhost:22128/jobs/prj-1?tab=claims", waiting until "networkidle"
