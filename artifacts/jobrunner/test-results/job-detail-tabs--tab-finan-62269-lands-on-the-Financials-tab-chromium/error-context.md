...
- Name: job-detail-tabs.spec.ts >> ?tab=financials deep link lands on the Financials tab
- Location: e2e/job-detail-tabs.spec.ts:247:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:22128/jobs/prj-1?tab=financials
Call log:
  - navigating to "http://localhost:22128/jobs/prj-1?tab=financials", waiting until "networkidle"
