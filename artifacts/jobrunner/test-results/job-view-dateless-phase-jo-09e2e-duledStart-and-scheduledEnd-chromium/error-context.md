...
- Name: job-view-dateless-phase.spec.ts >> job-view timeline renders without errors when a phase has null scheduledStart and scheduledEnd
- Location: e2e/job-view-dateless-phase.spec.ts:161:1
...
```ts
  87  |   await page.route('**/api/integrations/health', (r) =>
  88  |     r.fulfill(json({ allReady: true }))
  89  |   );
  90  | }
  91  | 
  92  | // ---------------------------------------------------------------------------
  ...
  99  |   firstName: 'Alex',
  100 |   lastName: 'Smith',
  101 |   email: 'alex@example.com',
  102 |   role: 'worker',
  103 |   profileImageUrl: null,
  104 |   themeColor: null,
  105 |   isActive: true,
  106 | };
  107 | 
  108 | /** A project job that Alex is assigned to. */
  109 | const PROJECT_JOB = {
  110 |   id: 'job-dateless-1',
  111 |   title: 'Dateless Phase Project',
  112 |   jobType: 'project',
  113 |   status: 'active',
  114 |   scheduledAt: null,
  115 |   scheduledTime: null,
  116 |   address: null,
  117 |   assignedTo: 'w1',
  118 |   assignments: [{ memberId: 'w1', isActive: true }],
  119 | };
  120 | 
  121 | /** Phase with BOTH scheduledStart and scheduledEnd absent (null). */
  122 | const DATELESS_PHASE = {
  123 |   id: 'phase-dateless-1',
  124 |   jobId: 'job-dateless-1',
  125 |   phaseCode: 'FOUND',
  126 |   name: 'Foundation',
  127 |   scheduledStart: null,
  128 |   scheduledEnd: null,
  129 |   bookedHours: '4',
  130 |   status: 'not_started',
  131 |   sortOrder: 1,
  132 |   assignedUserId: 'w1',
  133 |   assignedUserIds: ['w1'],
  134 |   assignedUsers: [{ id: 'w1', name: 'Alex Smith', isLead: true }],
  135 |   jobTitle: 'Dateless Phase Project',
  136 |   jobType: 'project',
  137 | };
  138 | 
