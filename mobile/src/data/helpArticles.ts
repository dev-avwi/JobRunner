...
If your client loses the email, open the quote or invoice in JobRunner and tap **Resend** or **Copy Link** to share it again. Each link is unique and secure.`,
    deeplink: '/quotes',
    mobileDeeplink: '/more/quote/new',
  },
  // ─── Price List ───────────────────────────────────────────────────────────────
...
When adding a line item to a quote or job cost, tap **Add from Price List** and search or browse your catalogue. Select an item and it fills in with the preset name, description, and price. You can override the quantity and price before saving.
